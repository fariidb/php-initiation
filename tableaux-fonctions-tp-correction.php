...
<html>
    ...
    <body>
         ...
         */
        ?>
        <h2>1_ Créez un tableau de type numérique et stockez des valeurs de type entiers </h2>
        <?php
        $arrayNum = array(5, 66, 145, 2, 77, 599);
        ?>
        <pre>
        <?php print_r($arrayNum) ;?>
        </pre>
        <h2>2_ Comptez le nombre de valeurs stockées dans ce tableau</h2>
        <?php
        echo "Le tableau contient " . count($arrayNum) . " valeurs";
        ?>
        ...
        <?php
        echo "Voici le tableau classé par ordre croissant <br />";
        //sort($arrayNum);
        // attention sort() modifie les index des clés du tableau
        // asort() conserve les index des clés du tableau après le tri
        asort($arrayNum);
        ?>
        ...
        <?php
        echo "Voici le tableau classé par ordre décroissant <br />";
        //rsort($arrayNum);
        // de même que pour sort(), rsort() modifie les index des clés du tableau, la fonction crée un nouvel ordonnencement, plutôt utiliser arsort() pour conserver les indices
        arsort($arrayNum);
        ?>
        <pre><?php var_dump($arrayNum) ?></pre>
        ...
        <?php
        echo "Voici le tableau sous forme de chaîne de caractères : ";
         ...
         */
        $sousTableau = array_slice($arrayNum, 2, 2);
        ?>
        ...
        // Attention l'ordre des paramètres va compter. 
        // Si on passe d'abord le tableau 1, alors la fonction va chercher 
        // quelles valeurs ne sont pas dans le tableau 2
        ?>
        <pre>
        <?php print_r($idemTab1); ?>
        </pre>
            <?php
            ...
            ?>
        <pre>
        <?php print_r($idemTab2); ?>
        </pre>

        <h2>14_ Créer un tableau qui contient des valeurs en doublons. <br />
            Ensuite, affichez ce tableau avec une méthode de débug sans les doublons</h2>
        <?php
        $prenoms = array("John", "Cédric", "Martin", "Cécile", "John");
        ?>
        <pre>
        <?php print_r(array_unique($prenoms)); ?>
        </pre>
    </body>
</html>